...
class WhereToPop extends React.Component{
  componentWillMount() {
    this.loadFonts();
  }
    ...
    return(
      <View>
       <View style={styles.containerView}>
        ...
        <Text  style={{ fontFamily:'SanFranciscoBold',}}>  ANYWHERE</Text>
      </View>
      
      <View style={{borderBottomWidth:1,borderColor:'#d2d2d2'}}
      ></View>
      <Text  style={{ fontFamily:'SanFrancisco',}} >Paris, France</Text>
    </View>
