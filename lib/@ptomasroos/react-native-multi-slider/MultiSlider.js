      ...
      <View style={[styles.container, this.props.containerStyle]}>
        <View style={[styles.fullTrack, { width: sliderLength }]}>
          ...
          >
            ...
            >
              <Text style={{ fontSize:16, marginTop:Platform.OS ==='ios'? -15:-4,}} >{this.state.valueOne}</Text>
              <Marker
          ...
          <View style={[styles.markerContainer, markerContainerTwo, this.props.markerContainerStyle]}>
            ...
            >
              <Text style={{fontSize:16, marginTop:Platform.OS ==='ios'? -15:-4,}} >{this.state.valueTwo}</Text>
              <Marker
